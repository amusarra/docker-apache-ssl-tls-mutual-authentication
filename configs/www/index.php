...
<head>
  ...
  <title>Welcome to Apache SSL/TLS Mutual Authentication Test Environment - Home</title>
        ...
        <div class="row justify-content-md-center">
            <div class="mbr-white col-md-10">
                <h1 class="mbr-section-title mbr-bold pb-3 mbr-fonts-style display-1">
                    Apache SSL/TLS Mutual Authentication<br></h1>
                <h3 class="mbr-section-subtitle align-center mbr-light pb-3 mbr-fonts-style display-2">Test Environment</h3>
                <p class="mbr-text pb-3 mbr-fonts-style display-7">
                  The goal of this project is to provide a ready-to-use template that implements a system of <strong>mutual SSL/TLS authentication based on Apache HTTP</strong>.
                  <br/><br/>
                  You can use this environment to perform authentication tests using your digital certificate via the browser or through software that implements a client that uses mutual SSL/TLS authentication.
                </p>
