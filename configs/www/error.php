...
<head>
  ...
  <title>Apache SSL/TLS Mutual Authentication - Errors</title>
...
<body>
  <section class="menu cid-reL6PpOTyO" once="menu" id="menu1-7">
            ...
            <div class="navbar-brand">
                <span class="navbar-logo">
                    <a href="<?= getenv('REQUEST_SCHEME') . '://' . getenv('SERVER_NAME') . ':' . getenv('SERVER_PORT') ?>">
                         <img src="../assets/images/iconfinder-21-3319623-1-174x174.png" alt="Apache SSL/TLS Mutual Authentication" title="" style="height: 5.6rem;">
                    </a>
                </span>
            ...
            <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true"><li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link link text-white display-4" href="https://mobirise.com">
                        ...
                        Antonio Musarra's Blog</a></li><li class="nav-item"><a class="nav-link link text-white display-4" href="https://httpd.apache.org/">
                        
                        Apache HTTP Server</a></li></ul>
            <div class="navbar-buttons mbr-section-btn">
                <a class="btn btn-sm btn-primary display-4" href="<?= getenv('REQUEST_SCHEME') . '://' . getenv('SERVER_NAME') . ':' . getenv('SERVER_PORT') ?>/secure"><span class="mobi-mbri mobi-mbri-login mbr-iconfont mbr-iconfont-btn"></span>
                    Login
                </a>
            </div>
        </div>
...
<section class="engine"><a href="https://mobirise.info/y">html website templates</a></section><section class="cid-reL6PqfKwE mbr-fullscreen" id="header2-8">

    <div class="container align-center">
        <div class="row justify-content-md-center">
            <div class="mbr-white col-md-10">
                <h1 class="mbr-section-title mbr-bold pb-3 mbr-fonts-style display-1">
                    Errors occurred<br></h1>
                <h3 class="mbr-section-subtitle align-center mbr-light pb-3 mbr-fonts-style display-2">It was not possible to log-in :-(&nbsp;</h3>
                <p class="mbr-text pb-3 mbr-fonts-style display-7">Check that your digital certificate is valid.&nbsp;<br><br></p>
                <div class="mbr-section-btn"><a class="btn btn-md btn-primary display-4" href="https://github.com/amusarra/docker-apache-ssl-tls-mutual-authentication">GO TO THE PROJECT</a>
                    <a class="btn btn-md btn-danger display-4" href="<?= getenv('REQUEST_SCHEME') . '://' . getenv('SERVER_NAME') . ':' . getenv('SERVER_PORT') ?>/secure">LOGIN WITH YOUR DIGITAL CERTIFICATE</a></div>
            </div>
        </div>
    </div>
...
<section class="cid-reL6PqNUC9" id="footer1-9">
    <div class="container">
        <div class="media-container-row content text-white">
            <div class="col-12 col-md-3">
                <div class="media-wrap">
                    <a href="https://www.dontesta.it">
